...
extension OrderStatusMatch on OrderStatus {
  T match<T>(
      ...
      required T Function() emptyOrderBag,
    ...
    if (v == OrderStatus.emptyOrderBag) {
      return emptyOrderBag();
    }
  ...
  T matchAny<T>(
    ...
    if (v == OrderStatus.emptyOrderBag && emptyOrderBag != null) {
      return emptyOrderBag();
    }
